...
from config import wifi_led, blue_led, subscribe_TOPIC, publish_TOPIC  # Local definitions
...
async def main(client):
    ...
    while True:
        ...
        # await client.publish(publish_TOPIC, '{} {}'.format(n, client.REPUB_COUNT), qos = 1)
        n += 1
