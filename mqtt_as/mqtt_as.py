...
class MQTTClient(MQTT_base):
    ...
    async def connect(self):
        if not self._has_connected:
            self.dprint("try connect to wifi")
    ...
    async def _handle_msg(self):
        try:
            ...
            self.dprint('Error in _handle_msg.', e)
            pass
        self.dprint("_handle_msg error",self.isconnected())
